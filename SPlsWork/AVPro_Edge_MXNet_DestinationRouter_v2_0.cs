...
namespace UserModule_AVPRO_EDGE_MXNET_DESTINATIONROUTER_V2_0
{
    public class UserModuleClass_AVPRO_EDGE_MXNET_DESTINATIONROUTER_V2_0 : SplusObject
    {
        ...
        public void ONONLINE ( object __sender__ /*AVProEdgeMXNetLib.Components.DestinationRouterComponent SENDER */, AVProEdgeMXNetLib.EventArguments.DigEventArgs ARGS ) 
            { 
            DestinationRouterComponent  SENDER  = (DestinationRouterComponent )__sender__;
            try
            {
...
public override object FunctionMain (  object __obj__ ) 
    ...
    try
    {
        ...
        // RegisterEvent( ROUTER , ONONLINE , ONONLINE ) 
        try { g_criticalSection.Enter(); ROUTER .OnOnline  += ONONLINE; } finally { g_criticalSection.Leave(); }
        ; 
...
public UserModuleClass_AVPRO_EDGE_MXNET_DESTINATIONROUTER_V2_0 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
