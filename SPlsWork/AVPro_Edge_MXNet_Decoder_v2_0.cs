...
namespace UserModule_AVPRO_EDGE_MXNET_DECODER_V2_0
{
    public class UserModuleClass_AVPRO_EDGE_MXNET_DECODER_V2_0 : SplusObject
    {
        ...
        public void ONDEVICEID ( object __sender__ /*AVProEdgeMXNetLib.Components.DecoderComponent SENDER */, AVProEdgeMXNetLib.EventArguments.SerEventArgs ARGS ) 
            { 
            DecoderComponent  SENDER  = (DecoderComponent )__sender__;
            try
            {
        ...
        public void ONMACADDRESS ( object __sender__ /*AVProEdgeMXNetLib.Components.DecoderComponent SENDER */, AVProEdgeMXNetLib.EventArguments.SerEventArgs ARGS ) 
            { 
            DecoderComponent  SENDER  = (DecoderComponent )__sender__;
            try
            {
...
public override object FunctionMain (  object __obj__ ) 
    ...
    try
    {
        ...
        // RegisterEvent( DECODER , ONDEVICEID , ONDEVICEID ) 
        try { g_criticalSection.Enter(); DECODER .OnDeviceId  += ONDEVICEID; } finally { g_criticalSection.Leave(); }
        ; 
        __context__.SourceCodeLine = 339;
        // RegisterEvent( DECODER , ONMACADDRESS , ONMACADDRESS ) 
        try { g_criticalSection.Enter(); DECODER .OnMacAddress  += ONMACADDRESS; } finally { g_criticalSection.Leave(); }
        ; 
...
public UserModuleClass_AVPRO_EDGE_MXNET_DECODER_V2_0 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
...
const uint DEVICEIDFB__AnalogSerialOutput__ = 10;
const uint MACADDRESSFB__AnalogSerialOutput__ = 11;
