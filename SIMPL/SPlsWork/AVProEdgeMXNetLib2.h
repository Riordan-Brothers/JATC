...
namespace AVProEdgeMXNetLib.Components.Abstract;
     ...
     class EndpointComponent 
    {
        ...
        EventHandler OnDeviceId ( EndpointComponent sender, SerEventArgs args );
        EventHandler OnMacAddress ( EndpointComponent sender, SerEventArgs args );
...
namespace AVProEdgeMXNetLib.Components;
     ...
     class VwLayoutComponent 
    {
        ...
        EventHandler OnOnline ( VwLayoutComponent sender, DigEventArgs args );
     ...
     class VwLayoutRecallComponent 
    {
        ...
        EventHandler OnOnline ( VwLayoutRecallComponent sender, DigEventArgs args );
     ...
     class DestinationRouterComponent 
    {
        ...
        EventHandler OnOnline ( DestinationRouterComponent sender, DigEventArgs args );
     ...
     class IrPortComponent 
    {
        ...
        EventHandler OnOnline ( IrPortComponent sender, DigEventArgs args );
     ...
     class CecComponent 
    {
        ...
        EventHandler OnOnline ( CecComponent sender, DigEventArgs args );
     ...
     class DecoderComponent 
    {
        ...
        EventHandler OnDeviceId ( DecoderComponent sender, SerEventArgs args );
        EventHandler OnMacAddress ( DecoderComponent sender, SerEventArgs args );
     ...
     class VwDecoderAssignComponent 
    {
        ...
        EventHandler OnOnline ( VwDecoderAssignComponent sender, DigEventArgs args );
     ...
     class MultiDestinationRouterComponent 
    {
        ...
        EventHandler OnOnline ( MultiDestinationRouterComponent sender, DigEventArgs args );
     ...
     class SerialPortComponent 
    {
        ...
        EventHandler OnOnline ( SerialPortComponent sender, DigEventArgs args );
     ...
     class EncoderComponent 
    {
        ...
        EventHandler OnDeviceId ( EncoderComponent sender, SerEventArgs args );
        EventHandler OnMacAddress ( EncoderComponent sender, SerEventArgs args );
...
namespace AVProEdgeMXNetLib;
     ...
     class CommandProcessor 
    {
        ...
        EventHandler OnOfflineCount ( CommandProcessor sender, AnaEventArgs args );

        // class functions
        FUNCTION Configure ( INTEGER Id , STRING IPAddress , LONG_INTEGER PollTimeSec );
        FUNCTION Connect ();
        FUNCTION Disconnect ();
